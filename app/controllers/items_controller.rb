class ItemsController < ApplicationController
  ...
  def permitted_item_params
    [:user, :department, :location, :make, :model, :barcode, :serial, :express_service_code, :computer_name, :ip_address, :wireless_mac, :wired_mac, :swap_cycle_number, :swap_cycle_span, :warranty_end, :notes, :purchased, :received]
  end
end
